...
// ---------------------------------------------------------------------------
// NUEVA TABLA HASH PARA memo (clave → número de caminos)
// ---------------------------------------------------------------------------
...
// tabla hash para guardar los resultados ya calculados (memoización)
class TablaMemo {
private:
...
// ---------------------------------------------------------------------------
// NUEVA TABLA HASH PARA enProceso (solo guarda claves, como un set)
// ---------------------------------------------------------------------------
