...
Incialmente se planteó recorrer todos los pares de forma bruta. Luego, se consideró recorrer también todos los pares y unirlos si la distancia era menor que una variable fija que implementaría yo manualmente. SIn embargo, eso no garantizaba que se seleccionaran los pares correctos por lo que el margen de error aumentaba a un porcentaje muy alto.
